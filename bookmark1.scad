...
difference() {
	...
	translate([tab_thickness*2,top_thickness,5]) rotate([0,180,-draft_angle])
		cube([slot_thickness,bookmark_len-tab_thickness-top_thickness-slot_thickness*2,10]);
	translate([bookmark_width-tab_thickness*2,top_thickness,-5]) rotate([0,0,draft_angle])
		cube([slot_thickness,bookmark_len-tab_thickness-top_thickness-slot_thickness*2,10]);
	translate([tab_thickness+tan(draft_angle)*bookmark_len+slot_thickness,bookmark_len-tab_thickness*2,-5])
		cube([bookmark_width-tan(draft_angle)*bookmark_len*2-tab_thickness*2-slot_thickness*2,slot_thickness,10]);
}
